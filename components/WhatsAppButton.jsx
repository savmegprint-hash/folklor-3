...
// Plutajuće WhatsApp dugme — fiksirano u donjem desnom uglu na svim stranicama.
// Promenite broj ispod u vaš pravi broj (format: državni pozivni + broj bez +).
...
export default function WhatsAppButton() {
  return (
    <a
      ...
      onClick={() => base44.analytics.track({ eventName: "whatsapp_klik" })}
